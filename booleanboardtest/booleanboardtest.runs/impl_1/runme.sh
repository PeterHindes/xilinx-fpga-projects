...
HD_PWD='C:/Users/user/Documents/FPGA/booleanboardtest/booleanboardtest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sw.tcl -notrace
